...
from utils_test_clevr_humans import get_positional_encoding
...
class ClevrDataset(Dataset):
    def __init__(self, clevr_dir, split, dictionaries, features_dir='data', layout_dir='', use_layout_supervision=False, use_half=False):
        ...
        if split=='train':
            ...
            quest_json_filename = os.path.join(clevr_dir, 'CLEVR-Humans', 'CLEVR-Humans-test.json')
    ...
    def __getitem__(self, idx):
        ...
        question = utils_test_clevr_humans.to_dictionary_indexes(self.dictionaries[0], current_question['question'])
        # answer_class = self.dictionaries[2][answer.item()]
        return image, question, len(question), idx
