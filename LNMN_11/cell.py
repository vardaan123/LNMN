...
class Node(nn.Module):
    def __init__(self, n_operations, temperature):
...
class NetworkCell_4input(nn.Module):
    def __init__(self, n_operations, temperature, img_feat_dim, text_feat_dim, map_dim):
        super(NetworkCell_4input, self).__init__()
        self.n_operations = n_operations
        self.temperature = temperature
        self.n_nodes = 3
        self.node_list = nn.ModuleList([Node(self.n_operations, self.temperature) for _ in range(self.n_nodes)])
...
class NetworkAnswerCell_4input(nn.Module):
    def __init__(self, n_operations, temperature, img_feat_dim, text_feat_dim, map_dim, mem_dim):
